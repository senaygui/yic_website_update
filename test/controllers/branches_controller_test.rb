...
class BranchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post branches_url, params: { branch: { email: @branch.email, location: @branch.location, name: @branch.name, phone_number: @branch.phone_number, second_phone_number: @branch.second_phone_number } }
    end
  ...
  test "should update branch" do
    patch branch_url(@branch), params: { branch: { email: @branch.email, location: @branch.location, name: @branch.name, phone_number: @branch.phone_number, second_phone_number: @branch.second_phone_number } }
